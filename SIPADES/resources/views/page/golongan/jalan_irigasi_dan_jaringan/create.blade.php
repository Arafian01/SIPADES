<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('TAMBAH ASET JALAN, IRIGASI DAN JARINGAN') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form class="w-full  mx-auto" method="POST" action="{{ route('jalan_irigasi_dan_jaringan.store') }}">
                        ...
                        <div class="mb-5">
                            <label for="kontruksi"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kontruksi
                            </label>
                        ...
                        <div class="mb-5">
                            <label for="panjang"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Panjang
                            </label>
                        ...
                        <div class="mb-5">
                            <label for="lebar"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lebar
                            </label>
