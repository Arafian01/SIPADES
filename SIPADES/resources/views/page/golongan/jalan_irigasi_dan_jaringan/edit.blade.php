            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Formulir Edit Jalan, Irigasi dan Jaringan</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi jalan, irigasi dan jaringan dengan data yang valid</p>
                        </div>
                    </div>

                    <form action="{{ route('jalan_irigasi_dan_jaringan.update', $jalan_irigasi_dan_jaringan->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <select id="id_rekening" name="id_rekening" required
                                            ...
                                            @foreach ($rekening as $s)
                                                <option value="{{ $s->id }}" {{ old('id_rekening', $jalan_irigasi_dan_jaringan->aset->rekening->id) == $s->id ? 'selected' : '' }}>
                            ...
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                <div class="flex items-center mb-4">
                                    ...
                                    <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Detail Jalan/Irigasi</h4>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Kode Pemilik -->
                                    <div>
                                        ...
                                        <select id="kode_pemilik" name="kode_pemilik" required
                                            ...
                                            <option value="Pemerintah Desa" {{ old('kode_pemilik', $jalan_irigasi_dan_jaringan->kode_pemilik) == 'Pemerintah Desa' ? 'selected' : '' }}>Pemerintah Desa</option>
                                        </select>
                                        @error('kode_pemilik')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <select id="kode_belanja_bidang" name="kode_belanja_bidang" required
                                            ...
                                            <option value="Penyelengaraan Pemerintah Desa" {{ old('kode_belanja_bidang', $jalan_irigasi_dan_jaringan->aset->kode_belanja_bidang) == 'Penyelengaraan Pemerintah Desa' ? 'selected' : '' }}>Penyelengaraan Pemerintah Desa</option>
                                            <option value="Pelaksanaan Pembangunan Desa" {{ old('kode_belanja_bidang', $jalan_irigasi_dan_jaringan->aset->kode_belanja_bidang) == 'Pelaksanaan Pembangunan Desa' ? 'selected' : '' }}>Pelaksanaan Pembangunan Desa</option>
                                            <option value="Pembinaan Kemasyarakatan" {{ old('kode_belanja_bidang', $jalan_irigasi_dan_jaringan->aset->kode_belanja_bidang) == 'Pembinaan Kemasyarakatan' ? 'selected' : '' }}>Pembinaan Kemasyarakatan</option>
                                            <option value="Pemberdayaan Masyarakat Desa" {{ old('kode_belanja_bidang', $jalan_irigasi_dan_jaringan->aset->kode_belanja_bidang) == 'Pemberdayaan Masyarakat Desa' ? 'selected' : '' }}>Pemberdayaan Masyarakat</option>
                                            <option value="Penanggulangan Bencana, Darurat Dan Mendesak Desa" {{ old('kode_belanja_bidang', $jalan_irigasi_dan_jaringan->aset->kode_belanja_bidang) == 'Penanggulangan Bencana, Darurat Dan Mendesak Desa' ? 'selected' : '' }}>Penanggulangan Bencana, Darurat Dan Mendesak Desa</option>
                                        </select>
                                    ...
                                    <!-- Kontruksi -->
                                    <div>
                                        <label for="kontruksi" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kontruksi <span class="text-red-500">*</span></label>
                                    ...
                                    <!-- Panjang -->
                                    <div>
                                        <label for="panjang" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Panjang (m) <span class="text-red-500">*</span></label>
                                        <input type="number" id="panjang" name="panjang" min="0" step="0.01" required
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    ...
                                    <!-- Lebar -->
                                    <div>
                                        <label for="lebar" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Lebar (m) <span class="text-red-500">*</span></label>
                                        <input type="number" id="lebar" name="lebar" min="0" step="0.01" required
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    ...
                                    <!-- Luas -->
                                    <div>
                                        <label for="luas" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Luas (m²) <span class="text-red-500">*</span></label>
                                        <input type="number" id="luas" name="luas" min="0" step="0.01" required
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    ...
                                    <!-- Tanah -->
                                    <div>
                                        <label for="id_tanah" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tanah <span class="text-red-500">*</span></label>
                                        <select id="id_tanah" name="id_tanah" required
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            <option value="">Pilih Tanah...</option>
                                            @foreach ($tanah as $t)
                                                <option value="{{ $t->id }}" {{ old('id_tanah', $jalan_irigasi_dan_jaringan->id_tanah) == $t->id ? 'selected' : '' }}>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select id="asal" name="asal" required
                                            ...
                                            <option value="Kekayaan Asli Desa" {{ old('asal', $jalan_irigasi_dan_jaringan->aset->asal) == 'Kekayaan Asli Desa' ? 'selected' : '' }}>Kekayaan Asli Desa</option>
                                            <option value="APBDesa" {{ old('asal', $jalan_irigasi_dan_jaringan->aset->asal) == 'APBDesa' ? 'selected' : '' }}>APBDesa</option>
                                            <option value="Perolehan Lain Yang Sah" {{ old('asal', $jalan_irigasi_dan_jaringan->aset->asal) == 'Perolehan Lain Yang Sah' ? 'selected' : '' }}>Perolehan Lain Yang Sah</option>
                                        </select>
                                        @error('asal')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <select id="sumber_dana" name="sumber_dana" required
                                            ...
                                            <option value="Pendapatan Asli Desa" {{ old('sumber_dana', $jalan_irigasi_dan_jaringan->aset->sumber_dana) == 'Pendapatan Asli Desa' ? 'selected' : '' }}>Pendapatan Asli Desa</option>
                                            <option value="Dana Desa" {{ old('sumber_dana', $jalan_irigasi_dan_jaringan->aset->sumber_dana) == 'Dana Desa' ? 'selected' : '' }}>Dana Desa (Dropping APBN)</option>
                                            <option value="Alokasi Dana Desa" {{ old('sumber_dana', $jalan_irigasi_dan_jaringan->aset->sumber_dana) == 'Alokasi Dana Desa' ? 'selected' : '' }}>Alokasi Dana Desa</option>
                                            <option value="Penerimaan Bagi Hasil Pajak Retribusi Daerah" {{ old('sumber_dana', $jalan_irigasi_dan_jaringan->aset->sumber_dana) == 'Penerimaan Bagi Hasil Pajak Retribusi Daerah' ? 'selected' : '' }}>Penerimaan Bagi Hasil Pajak Retribusi Daerah</option>
                                            <option value="Penerimaan Bantuan Keuangan Kab/Kota" {{ old('sumber_dana', $jalan_irigasi_dan_jaringan->aset->sumber_dana) == 'Penerimaan Bantuan Keuangan Kab/Kota' ? 'selected' : '' }}>Penerimaan Bantuan Keuangan Kab/Kota</option>
                                            <option value="Penerimaan Bantuan Keuangan Provinsi" {{ old('sumber_dana', $jalan_irigasi_dan_jaringan->aset->sumber_dana) == 'Penerimaan Bantuan Keuangan Provinsi' ? 'selected' : '' }}>Penerimaan Bantuan Keuangan Provinsi</option>
                                            <option value="Swadaya Masyarakat" {{ old('sumber_dana', $jalan_irigasi_dan_jaringan->aset->sumber_dana) == 'Swadaya Masyarakat' ? 'selected' : '' }}>Swadaya Masyarakat</option>
                                            <option value="Pendapatan Lain Lain" {{ old('sumber_dana', $jalan_irigasi_dan_jaringan->aset->sumber_dana) == 'Pendapatan Lain Lain' ? 'selected' : '' }}>Pendapatan Lain Lain</option>
                                        </select>
                                        @error('sumber_dana')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select id="kondisi" name="kondisi" required
                                            ...
                                            <option value="Baik" {{ old('kondisi', $jalan_irigasi_dan_jaringan->aset->kondisi) == 'Baik' ? 'selected' : '' }}>Baik</option>
                                            <option value="Kurang Baik" {{ old('kondisi', $jalan_irigasi_dan_jaringan->aset->kondisi) == 'Kurang Baik' ? 'selected' : '' }}>Kurang Baik</option>
                                            <option value="Rusak Ringan" {{ old('kondisi', $jalan_irigasi_dan_jaringan->aset->kondisi) == 'Rusak Ringan' ? 'selected' : '' }}>Rusak Ringan</option>
                                            <option value="Rusak Berat" {{ old('kondisi', $jalan_irigasi_dan_jaringan->aset->kondisi) == 'Rusak Berat' ? 'selected' : '' }}>Rusak Berat</option>
                                        </select>
                                        @error('kondisi')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <select id="perolehan" name="perolehan" required
                                            ...
                                            <option value="Inventarisasi" {{ old('perolehan', $jalan_irigasi_dan_jaringan->perolehan) == 'Inventarisasi' ? 'selected' : '' }}>Inventarisasi</option>
                                        </select>
                                        @error('perolehan')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
