            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Formulir Pendaftaran Aset Tanah</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Silakan isi semua field yang diperlukan dengan data yang valid.</p>
                        </div>
                    </div>

                    <form class="space-y-6" method="POST" action="{{ route('tanah.store') }}">
                        @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select id="id_rekening" name="id_rekening" class="js-select2 w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                            ...
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select id="kode_pemilik" name="kode_pemilik" class="js-select2 w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                                    ...
                                    <div>
                                        ...
                                        <select id="kode_belanja_bidang" name="kode_belanja_bidang" class="js-select2 w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                                    ...
                                    <div>
                                        ...
                                        <select id="asal" name="asal" class="js-select2 w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                                    ...
                                    <div>
                                        ...
                                        <select id="sumber_dana" name="sumber_dana" class="js-select2 w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                            ...
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                <div class="flex items-center mb-4">
                                    ...
                                    <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Detail Tanah</h4>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Tanggal Perolehan -->
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <select id="status" name="status" class="js-select2 w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                                            <option value="">Pilih Status...</option>
                                            <option value="Sertifikat - Hak Pakai" {{ old('status') == 'Sertifikat - Hak Pakai' ? 'selected' : '' }}>Sertifikat - Hak Pakai</option>
                                            <option value="Bukti Lainnya - Letter C" {{ old('status') == 'Bukti Lainnya - Letter C' ? 'selected' : '' }}>Bukti Lainnya - Letter C</option>
                                            <option value="Bukti Lainnya - Girik" {{ old('status') == 'Bukti Lainnya - Girik' ? 'selected' : '' }}>Bukti Lainnya - Girik</option>
                                            <option value="Bukti Lainnya - Surat Keterangan" {{ old('status') == 'Bukti Lainnya - Surat Keterangan' ? 'selected' : '' }}>Bukti Lainnya - Surat Keterangan</option>
                                            <option value="Bukti Lainnya - Surat Penguasaan Fisik" {{ old('status') == 'Bukti Lainnya - Surat Penguasaan Fisik' ? 'selected' : '' }}>Bukti Lainnya - Surat Penguasaan Fisik</option>
                                            <option value="Bukti Lainnya - Bukti Inventaritasi Aset" {{ old('status') == 'Bukti Lainnya - Bukti Inventaritasi Aset' ? 'selected' : '' }}>Bukti Lainnya - Bukti Inventaritasi Aset</option>
                                        </select>
                                        @error('status')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <select id="perolehan" name="perolehan" class="js-select2 w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                                            <option value="">Pilih Perolehan...</option>
                                            <option value="Inventarisasi" {{ old('perolehan') == 'Inventarisasi' ? 'selected' : '' }}>Inventarisasi</option>
                                        </select>
                                        @error('perolehan')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <!-- Tanggal Sertifikat -->
                                    <div>
                                        <label for="tanggal_sertifikat" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tanggal Sertifikat</label>
                                        <div class="relative">
                                    ...
                                    <!-- Nomor Sertifikat -->
                                    <div>
                                        <label for="no_sertifikat" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nomor Sertifikat</label>
                            ...
                            <!-- Section 4: Nilai & Kondisi -->
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                <div class="flex items-center mb-4">
                                    <div class="w-1 h-6 bg-purple-500 mr-3"></div>
                                    <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Nilai & Kondisi</h4>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Nilai Perolehan -->
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <select id="kondisi" name="kondisi" class="js-select2 w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                                    ...
                                    <!-- Kode Lokasi -->
                                    <div>
                                        <label for="kode_lokasi" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kode Lokasi <span class="text-red-500">*</span></label>
                            ...
                            <!-- Section 5: Batas Tanah -->
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                <div class="flex items-center mb-4">
                                    <div class="w-1 h-6 bg-red-500 mr-3"></div>
                                    <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Batas Tanah</h4>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Batas Utara -->
                                    <div>
                                        <label for="batas_utara" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Batas Utara <span class="text-red-500">*</span></label>
                                        <input type="text" id="batas_utara" name="batas_utara"
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('batas_utara') }}" required />
                                        @error('batas_utara')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <!-- Batas Timur -->
                                    <div>
                                        <label for="batas_timur" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Batas Timur <span class="text-red-500">*</span></label>
                                        <input type="text" id="batas_timur" name="batas_timur"
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('batas_timur') }}" required />
                                        @error('batas_timur')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <!-- Batas Selatan -->
                                    <div>
                                        <label for="batas_selatan" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Batas Selatan <span class="text-red-500">*</span></label>
                                        <input type="text" id="batas_selatan" name="batas_selatan"
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('batas_selatan') }}" required />
                                        @error('batas_selatan')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <!-- Batas Barat -->
                                    <div>
                                        <label for="batas_barat" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Batas Barat <span class="text-red-500">*</span></label>
                                        <input type="text" id="batas_barat" name="batas_barat"
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('batas_barat') }}" required />
                                        @error('batas_barat')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                <div class="flex items-center mb-4">
                                    ...
                                    <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Informasi Tambahan</h4>
                                </div>
                                <div class="grid grid-cols-1 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="alamat" name="alamat" rows="3"
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('alamat') }}</textarea>
                                        @error('alamat')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    </div>
