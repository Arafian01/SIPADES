        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('peralatan_dan_mesin.store') }}">
                        @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                <div class="flex items-center mb-4">
                                    ...
                                    <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Spesifikasi Aset
                                    </h4>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Merk/Type -->
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Merk
                                    ...
                                    <div>
                                        <label for="ukuran"
                                            ...
                                            / CC</label>
                                        <div class="relative">
                                            <input type="number" id="ukuran" name="ukuran" min="0"
                                                step="0.01"
                                                class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                                value="{{ old('ukuran') }}" />
                                            <div
                                                class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 dark:text-gray-400 text-sm">cc</span>
                                            </div>
                                        </div>
                                        @error('ukuran')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            ...
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                <div class="flex items-center mb-4">
                                    ...
                                    <h4 class="text-lg font-medium text-gray-800 dark:text-gray-200">Nomor Identifikasi
                                    </h4>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Nomor Pabrik -->
