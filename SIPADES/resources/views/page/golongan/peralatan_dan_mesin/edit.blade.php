                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('peralatan_dan_mesin.update', $peralatan_dan_mesin->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" id="ruang" name="ruang"
                                    ...
                                    value="{{ old('nama_label', $peralatan_dan_mesin->ruang) }}" required />
                                @error('nama_label')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input type="date" id="tanggal_perolehan" name="tanggal_perolehan"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                                    value="{{ old('tanggal_perolehan', $peralatan_dan_mesin->tanggal_perolehan) }}"
                                    required />
                            ...
                            <div class="mb-5">
                                ...
                                <select class="js-select2 form-control w-full" id="kondisi" name="kondisi"
                                    required>
                                    <option value="Baik"
                                        {{ old('kondisi', $peralatan_dan_mesin->aset->kondisi) == 'Baik' ? 'selected' : '' }}>Baik</option>
                                    <option value="Kurang Baik"
                                        {{ old('kondisi', $peralatan_dan_mesin->aset->kondisi) == 'Kurang Baik' ? 'selected' : '' }}>Kurang
                                        Baik</option>
                                    <option value="Rusak Ringan"
                                        {{ old('kondisi', $peralatan_dan_mesin->aset->kondisi) == 'Rusak Ringan' ? 'selected' : '' }}>Rusak
                                        Ringan</option>
                                    <option value="Rusak Berat"
                                        {{ old('kondisi', $peralatan_dan_mesin->aset->kondisi) == 'Rusak Berat' ? 'selected' : '' }}>Rusak
                                        Berat</option>
                                </select>
                                @error('kondisi')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div class="mb-5 md:col-span-2">
                                ...
                                <textarea id="keterangan" name="keterangan" rows="4"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">{{ old('keterangan', $peralatan_dan_mesin->aset->keterangan) }}</textarea>
                                @error('keterangan')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="flex justify-end gap-4 mt-6">
                            <a href="{{ route('peralatan_dan_mesin.index') }}"
