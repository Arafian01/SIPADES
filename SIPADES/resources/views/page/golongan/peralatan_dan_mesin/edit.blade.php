                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Perbarui informasi peralatan dan mesin dengan data yang
                                valid</p>
                        </div>
                    </div>

                    <form action="{{ route('peralatan_dan_mesin.update', $peralatan_dan_mesin->id) }}" method="POST"
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="card bg-gray-50 p-6 rounded-lg shadow-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Id Barang -->
                                    <div>
                                        <label for="id_barang" class="block text-sm font-medium text-gray-700 mb-1">ID
                                            Barang</label>
                                        <div class="relative">
                                    ...
                                    <!-- Nomor Register -->
                                    <div>
                                        <label for="no_reg" class="block text-sm font-medium text-gray-700 mb-1">Nomor
                                            Register <span class="text-red-500">*</span></label>
                                        <input type="text" id="no_reg" name="no_reg" readonly
                                            class="w-full bg-gray-100 border border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-not-allowed"
                                            value="{{ old('no_reg', $peralatan_dan_mesin->aset->nomor_register) }}"
                                            required />
                                        @error('no_reg')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        <label for="id_rekening"
                                            class="block text-sm font-medium text-gray-700 mb-1">Kode Aset <span
                                    ...
                                    <div>
                                        <label for="nama_label"
                                            class="block text-sm font-medium text-gray-700 mb-1">Nama Label <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" id="nama_label" name="nama_label"
                                            class="w-full border border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('nama_label', $peralatan_dan_mesin->aset->nama_label) }}"
                                            required />
                                        @error('nama_label')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="kode_pemilik"
                                            class="block text-sm font-medium text-gray-700 mb-1">Pemilik <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <!-- Ruang -->
                                    <div>
                                        <label for="ruang" class="block text-sm font-medium text-gray-700 mb-1">Ruang
                                    ...
                                    <div>
                                        <label for="kode_belanja_bidang"
                                            class="block text-sm font-medium text-gray-700 mb-1">Belanja Bidang <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="merk"
                                            class="block text-sm font-medium text-gray-700 mb-1">Merk/Type <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="ukuran"
                                            class="block text-sm font-medium text-gray-700 mb-1">Ukuran/CC <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="bahan"
                                            class="block text-sm font-medium text-gray-700 mb-1">Bahan <span
                                                class="text-red-500">*</span></label>
                            ...
                            <div class="card bg-gray-50 p-6 rounded-lg shadow-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="asal"
                                            class="block text-sm font-medium text-gray-700 mb-1">Asal <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="sumber_dana"
                                            class="block text-sm font-medium text-gray-700 mb-1">Sumber Dana <span
                                                class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="tanggal_perolehan"
                                            class="block text-sm font-medium text-gray-700 mb-1">Tanggal Perolehan
                                            <span class="text-red-500">*</span></label>
                                        <div class="relative">
                                    ...
                                    <div>
                                        <label for="nilai_perolehan"
                                            class="block text-sm font-medium text-gray-700 mb-1">Nilai Perolehan (Rp)
                                            <span class="text-red-500">*</span></label>
                                        <div class="relative">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="nomor_pabrik"
                                            class="block text-sm font-medium text-gray-700 mb-1">Nomor Pabrik <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" id="nomor_pabrik" name="nomor_pabrik"
                                            class="w-full border border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('nomor_pabrik', $peralatan_dan_mesin->nomor_pabrik) }}"
                                            required />
                                        @error('nomor_pabrik')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        <label for="nomor_rangka"
                                            class="block text-sm font-medium text-gray-700 mb-1">Nomor Rangka <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" id="nomor_rangka" name="nomor_rangka"
                                            class="w-full border border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('nomor_rangka', $peralatan_dan_mesin->nomor_rangka) }}"
                                            required />
                                        @error('nomor_rangka')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        <label for="nomor_mesin"
                                            class="block text-sm font-medium text-gray-700 mb-1">Nomor Mesin <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" id="nomor_mesin" name="nomor_mesin"
                                            class="w-full border border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('nomor_mesin', $peralatan_dan_mesin->nomor_mesin) }}"
                                            required />
                                        @error('nomor_mesin')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        <label for="nomor_polisi"
                                            class="block text-sm font-medium text-gray-700 mb-1">Nomor Polisi <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" id="nomor_polisi" name="nomor_polisi"
                                            class="w-full border border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('nomor_polisi', $peralatan_dan_mesin->nomor_polisi) }}"
                                            required />
                                        @error('nomor_polisi')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        <label for="nomor_bpkb"
                                            class="block text-sm font-medium text-gray-700 mb-1">Nomor BPKB <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" id="nomor_bpkb" name="nomor_bpkb"
                                            class="w-full border border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('nomor_bpkb', $peralatan_dan_mesin->nomor_bpkb) }}"
                                            required />
                                        @error('nomor_bpkb')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                            ...
                            <div class="card bg-gray-50 p-6 rounded-lg shadow-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="kondisi"
                                            class="block text-sm font-medium text-gray-700 mb-1">Kondisi <span
                                                class="text-red-500">*</span></label>
                                        <select id="kondisi" name="kondisi" required
                                            class="w-full border border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            <option value="">Pilih Kondisi...</option>
                                            <option value="Baik"
                                                {{ old('kondisi', $peralatan_dan_mesin->aset->kondisi) == 'Baik' ? 'selected' : '' }}>
                                                Baik</option>
                                            <option value="Kurang Baik"
                                                {{ old('kondisi', $peralatan_dan_mesin->aset->kondisi) == 'Kurang Baik' ? 'selected' : '' }}>
                                                Kurang Baik</option>
                                            <option value="Rusak Ringan"
                                                {{ old('kondisi', $peralatan_dan_mesin->aset->kondisi) == 'Rusak Ringan' ? 'selected' : '' }}>
                                                Rusak Ringan</option>
                                            <option value="Rusak Berat"
                                                {{ old('kondisi', $peralatan_dan_mesin->aset->kondisi) == 'Rusak Berat' ? 'selected' : '' }}>
                                                Rusak Berat</option>
                                        </select>
                                        @error('kondisi')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    ...
                                    <div>
                                        <label for="perolehan"
                                            class="block text-sm font-medium text-gray-700 mb-1">Perolehan <span
                                                class="text-red-500">*</span></label>
                                        <select id="perolehan" name="perolehan" required
                                            class="w-full border border-gray-300 rounded-md py-2 px-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                            <option value="">Pilih Perolehan...</option>
                                            <option value="Inventarisasi"
                                                {{ old('perolehan', $peralatan_dan_mesin->perolehan) == 'Inventarisasi' ? 'selected' : '' }}>
                                    ...
                                    <div>
                                        <label for="tanggal_pembukuan"
                                            class="block text-sm font-medium text-gray-700 mb-1">Tanggal Pembukuan
                                            <span class="text-red-500">*</span></label>
                                        <div class="relative">
