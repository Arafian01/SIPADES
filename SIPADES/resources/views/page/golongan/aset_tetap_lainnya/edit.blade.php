            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Formulir Edit Aset Tetap
                                Lainnya</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi aset tetap lainnya
                                dengan data yang valid</p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="no_reg" name="no_reg" readonly
                                            class="w-full bg-gray-100 dark:bg-gray-600 border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-not-allowed"
                                            value="{{ old('no_reg', $aset_tetap_lainnya->aset->nomor_register) }}"
                                            required />
                                        @error('no_reg')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="nama_label" name="nama_label"
                                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value="{{ old('nama_label', $aset_tetap_lainnya->aset->nama_label) }}"
                                            required />
                                        @error('nama_label')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                        @enderror
                            ...
                            <div class="card bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="ruang"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ruang
                                            <span class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="judul"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Judul
                                            <span class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="pencipta"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pencipta
                                            <span class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="ukuran"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Ukuran
                                            <span class="text-red-500">*</span></label>
                                    ...
                                    <div>
                                        <label for="bahan"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Bahan
                                            <span class="text-red-500">*</span></label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select id="kondisi" name="kondisi" required
                                            ...
                                            <option value="Baik"
                                                {{ old('kondisi', $aset_tetap_lainnya->aset->kondisi) == 'Baik' ? 'selected' : '' }}>
                                                Baik</option>
                                            <option value="Kurang Baik"
                                                {{ old('kondisi', $aset_tetap_lainnya->aset->kondisi) == 'Kurang Baik' ? 'selected' : '' }}>
                                                Kurang Baik</option>
                                            <option value="Rusak Ringan"
                                                {{ old('kondisi', $aset_tetap_lainnya->aset->kondisi) == 'Rusak Ringan' ? 'selected' : '' }}>
                                                Rusak Ringan</option>
                                            <option value="Rusak Berat"
                                                {{ old('kondisi', $aset_tetap_lainnya->aset->kondisi) == 'Rusak Berat' ? 'selected' : '' }}>
                                                Rusak Berat</option>
                                        </select>
                                        @error('kondisi')
                                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
