        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form class="w-full  mx-auto" method="POST" action="{{ route('aset_tetap_lainnya.store') }}">
                        @csrf
                        <div class="mb-5">
                            <label for="id_barang"
                        ...
                        <div class="mb-5">
                            <label for="pencipta"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">pencipta
                            </label>
