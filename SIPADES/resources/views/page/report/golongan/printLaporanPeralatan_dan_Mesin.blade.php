        ...
        <div class="page" id="result">
            <div class="ml-[6px] mr-[90px]">
                ...
                <div class="ml-10">
                    ...
                    <h6>NAMA : PERALATAN DAN MESIN</h6>
                ...
                <table class="border border-1 border-black w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border border-1 border-black" rowspan="2">Merk/Type</th>
                            <th class="border border-1 border-black" rowspan="2">Ukuran/CC</th>
                            ...
                            <th class="border border-1 border-black" colspan="5">Nomor</th>
                            <th class="border border-1 border-black" rowspan="2">Cara Perolehan/<br>Status Barang/<br>Kondisi/<br>Penggunaan</th>
                        ...
                        <tr class="kp">
                            ...
                            <td class="border border-1 border-black">Pabrik</td>
                            <td class="border border-1 border-black">Rangka</td>
                            <td class="border border-1 border-black">Mesin</td>
                            <td class="border border-1 border-black">Polisi</td>
                            <td class="border border-1 border-black">BPKB</td>
                        </tr>
                        <tr class="kp">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td class="border border-1 border-black text-left pl-2">{{ $d->merk }}</td>
                                <td class="border border-1 border-black text-left pl-2">{{ $d->ukuran }}</td>
                                <td class="border border-1 border-black text-left pl-2">{{ $d->bahan }}</td>
