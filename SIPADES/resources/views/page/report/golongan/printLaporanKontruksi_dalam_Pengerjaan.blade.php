    ...
    <div class="book">
        <div class="page" id="result">
            <div class="ml-[6px] mr-[90px]">
                <h2 class="judul">KARTU INVENTARIS BARANG (KIB) F<br>KONTRUKSI DALAM PENGERJAAN<br>2025</h2>
                <div class="ml-10">
                    <h6>PROVINSI : Jawa Barat</h6>
                    <h6>KABUPATEN/KOTA : Tasikmalaya</h6>
                    <h6>KECAMATAN : Cigalontang</h6>
                    <h6>NAMA : Kontruksi Dalam Pengerjaan</h6>
                ...
                <table class="border border-1 border-black w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border border-1 border-black" rowspan="2">Nomor Dokumen</th>
                            <th class="border border-1 border-black" rowspan="2">Tanggal Dokumen</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td class="border border-1 border-black text-left pl-2">{{ $d->nomor_dokumen }}</td>
