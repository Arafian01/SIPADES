                ...
                <table class="border border-1 border-black w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border border-1 border-black" rowspan="2">Ruang</th>
                            <th class="border border-1 border-black" rowspan="2">Judul</th>
                            <th class="border border-1 border-black" rowspan="2">Pencipta</th>
                            <th class="border border-1 border-black" rowspan="2">Ukuran</th>
                            <th class="border border-1 border-black" rowspan="2">Bahan</th>
                            <th class="border border-1 border-black" rowspan="2">Tahun Perolehan</th>
                            <th class="border border-1 border-black" rowspan="2">Asal/Cara Perolehan</th>
                            <th class="border border-1 border-black" rowspan="2">Sumber Dana</th>
                            <th class="border border-1 border-black" rowspan="2">Kondisi</th>
                            <th class="border border-1 border-black" rowspan="2">Harga/Rp</th>
                            <th class="border border-1 border-black" rowspan="2">Keterangan</th>
                        </tr>
                        <tr class="kp">
                            <td class="border border-1 border-black">No</td>
                            <td class="border border-1 border-black">Kode Barang</td>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td class="border border-1 border-black text-left pl-2">
                                    {{ $d->aset->rekening->nama_rekening }}</td>
                                <td class="border border-1 border-black text-left pl-2">{{ $d->ruang }}</td>
                                <td class="border border-1 border-black pl-2">{{ $d->judul }}</td>
                                <td class="border border-1 border-black pl-2">{{ $d->pencipta }}</td>
                                <td class="border border-1 border-black pl-2">{{ $d->ukuran}}</td>
                                <td class="border border-1 border-black pl-2">{{ $d->bahan}}</td>
                                ...
                                <td class="border border-1 border-black pl-2">{{ $d->aset->sumber_dana }}</td>
