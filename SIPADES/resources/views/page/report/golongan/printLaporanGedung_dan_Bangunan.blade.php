        ...
        <div class="page" id="result">
            <div class="ml-[6px] mr-[90px]">
                ...
                <div class="ml-10">
                    ...
                    <h6>NAMA : GEDUNG DAN BANGUNAN</h6>
                ...
                <table class="border border-1 border-black w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="border border-1 border-black" rowspan="2">Kondisi<br>Bangunan<br>(B,KB,RB)</th>
                            <th class="border border-1 border-black" colspan="2">Kontruksi Bangunan</th>
                            <th class="border border-1 border-black" rowspan="2">Luas<br>Lantai<br>(M2)</th>
                            <th class="border border-1 border-black" rowspan="2">Letak/Alamat</th>
                            <th class="border border-1 border-black" rowspan="2">Dokumen<br>Gedung</th>
                            <th class="border border-1 border-black" rowspan="2">Luas<br>Tanah<br>(M2)</th>
                            <th class="border border-1 border-black" rowspan="2">Status<br>tanah</th>
                            <th class="border border-1 border-black" rowspan="2">Nomor<br>Kode Tanah</th>
                            <th class="border border-1 border-black" rowspan="2">Cara<br>Perolehan/Status<br>Barang/<br>Kondisi</th>
                        ...
                        <tr class="kp">
                            ...
                            <td class="border border-1 border-black">Bertingkat/<br>Tidak</td>
                            <td class="border border-1 border-black">Beton/<br>Tidak</td>
                        </tr>
                        <tr class="kp">
